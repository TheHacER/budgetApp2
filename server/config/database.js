...
async function migrate(db) {
  const schema = `
    ...
    CREATE TABLE IF NOT EXISTS categories ( 
        ...
        FOREIGN KEY (linked_savings_account_id) REFERENCES savings_accounts (id) ON DELETE SET NULL
    );
    ...
    CREATE TABLE IF NOT EXISTS budgets ( 
        ...
        budget_type TEXT CHECK(budget_type IN ('allowance', 'rolling')) NOT NULL DEFAULT 'allowance',
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP, 
    ...
    CREATE TABLE IF NOT EXISTS monthly_history (
        ...
        final_surplus_or_rollover REAL NOT NULL,
