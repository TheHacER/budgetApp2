    ...
    <div className="container mx-auto p-4 md:p-6">
      ...
      <Tabs defaultValue="categories" className="w-full">
        ...
        <TabsContent value="categories">
          <Card>
            <CardHeader><CardTitle>Manage Categories</CardTitle><CardDescription>Add, edit, or delete your spending categories.</CardDescription></CardHeader>
        ...
        <TabsContent value="savings">
           <Card>
            <CardHeader><CardTitle>Manage Savings</CardTitle><CardDescription>Define your savings accounts and set financial goals.</CardDescription></CardHeader>
